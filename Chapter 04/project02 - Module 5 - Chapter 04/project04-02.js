...
function quoteGenerator() {
      ...
      let randomQuote = randomInt(0, quoteCount - 1); // Adjusted to avoid out-of-bounds error

      // Retrieve a randomly-selected quote
      let quote = quotes[randomQuote]; // Fixed typo from randomQuotes to randomQuote

      // Display the random quote
      document.getElementsByTagName("blockquote")[0].innerHTML = quote; // Corrected index
}

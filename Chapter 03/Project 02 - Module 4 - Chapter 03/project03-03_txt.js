...
/*Create a for loop with a counter that goes from 0 to less the length of the titles array in increments of 1.
 ...
 for (var i = 0; i < titles.length; i++) {
  htmlCode += `<tr>
              ...
              // had to add `backtic marks to the string to embed an expression & ${} is a template literal and displays the value
}

/*After the for loop, declare a variable named tableBody referencing the first (and only) element in the web document 
with the tag name “tbody”. (Hint: Use the getElementsByTagName() method to access the HTML collection and don’t forget 
to reference the first element in that collection and not the whole collection.)*/

var tableBody = document.getElementsByTagName("tbody")[0]; // Reference first 'tbody' element

//hange the innerHTML property of tableBody to the value of the htmlCode variable.

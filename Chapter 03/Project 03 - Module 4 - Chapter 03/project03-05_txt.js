...
/*The program declares two arrays named phones and sales that contain the names 
of the five phone models and their units sold. There is an error in declaring each of these arrays. 
Locate and fix those errors.*/
...
/*In the for loop that writes the td elements for the bar chart, there are errors defining the counter values. 
Locate and fix the errors involved.*/
for (let i = 0; i < phones.length; i++) {
   ...
   /*Fix the error in the statement that declares and initializes the 
   barPercent variable (which calculates the sales percentage for a specific phone model.) */
   ...
   /*Fix the syntax errors in the switch statement that sets the value of the cellTag variable based on name of the phone model.*/
   switch (phones[i]) {
      case "Photon 6E": 
...
//Fix the error in the statement that runs the forEach() method.
